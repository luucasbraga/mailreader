...
/**
 * Interface que define o contrato para extração de despesas a partir de documentos DARF
 * (Documento de Arrecadação de Receitas Federais).
 * <p>
 * Implementações desta interface devem transformar o conteúdo textual extraído do documento
 * numa instância de {@link Expense}, garantindo que os dados fiscais sejam convertidos
 ...
 * @since 2025
 */
public interface DarfExtractor extends ExpenseExtractor {
