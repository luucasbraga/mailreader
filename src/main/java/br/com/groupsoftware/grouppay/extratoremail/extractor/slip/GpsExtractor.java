...
/**
 * Interface que define o contrato para extração de despesas a partir de GPS
 * (Guia da Previdência Social).
 * <p>
 * Implementações desta interface devem transformar o conteúdo textual extraído do documento
 * numa instância de {@link Expense}, garantindo que os dados previdenciários sejam convertidos
 ...
 * @since 2025
 */
public interface GpsExtractor extends ExpenseExtractor {
