...
/**
 * ‘Interface’ que define o contrato para extração de despesas a partir de textos de boletos bancários.
 * <p>
 ...
 * </p>
 * <p>
 * Essa ‘interface’ é usada para processar e extrair informações essenciais de boletos bancários,
 * como valores, vencimentos e dados do emissor, permitindo o seu uso em sistemas de controle financeiro.
 * </p>
 *
 * @author Marco Willy
 * @version 1.0
 * @since 2025
 */
public interface BankSlipExtractor extends ExpenseExtractor {
