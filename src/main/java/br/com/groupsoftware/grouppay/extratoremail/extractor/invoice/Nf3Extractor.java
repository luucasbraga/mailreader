...
/**
 * ‘Interface’ que define o contrato para extração de despesas a partir de textos de documentos NF³-e.
 ...
 * de notas fiscais de energia elétrica (NF³-e), garantindo que os dados sejam convertidos de maneira
 ...
 * @since 2024
 */
public interface Nf3Extractor extends ExpenseExtractor {
