...
/**
 * ‘Interface’ que define o contrato para extração de despesas a partir de textos de documentos NFC-e.
 ...
 * de notas fiscais de consumo (NFC-e), garantindo que os dados sejam convertidos de maneira
 ...
 * @since 2025
 */
public interface NfcExtractor extends ExpenseExtractor {
